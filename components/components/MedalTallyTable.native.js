...
import { fetchFilterOptions, fetchMedallTallyData, loginApi, registerApi } from '@/apis/common_apis/common_apis';
...
const MedalTallyTable = () => {
  ...
  function fetchData(){
    ...
    var res =  registerApi("akhlaqaltaf4@gmail.com","1234567");
    var res2 = loginApi("akhlaqaltaf4@gmail.com","1234567");
